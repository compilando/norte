...
| `rename-log/` | `org.norte.rename-log` | hook | After a rename lands in the journal — yours, an agent's, a batch, an undo — says in the status bar how many files it touched (`after-renamed`). Observes; changes nothing (ADR 0100). |
