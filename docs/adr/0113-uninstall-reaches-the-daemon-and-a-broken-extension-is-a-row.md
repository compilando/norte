...
Bridge 79 carries it: `ExtensionErrorView.id: Option<String>`, and the
...
- Protocol unchanged. Bridge 78 → 79; the renderer's constant moves with it
  and the corpus shape pin was updated in the same change. It was written as
  the 69 on a branch that reached `main` after the 78, and renumbered when it
  landed.
