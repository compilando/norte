...
use text::{
    badge_prefixed, cells, clamp_chars, clamp_spans, fit_hint_groups, head,
    middle, right_ellipsis, tail_window, take_width, two_fields, with_badge, wrapped_rows,
};
...
mod help_footer_tests {
    use super::text::{cells, fit_hint_groups, hint_groups};
