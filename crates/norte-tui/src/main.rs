...
use norte_tui::app::{
    ...
    Modal, NavPopup, NavPopupKind, PAGE, Palette, PendingWrite, PickerAction, SearchDialog,
    SearchState, Settings, SettingsEditError, Shortcuts, Trail, TrailStep, TransferKind,
    config_error_category, detail_for_bar, dialog_action, error_category, error_message,
    io_error_category, keymaps_error_category, theme_error_category, volume_items,
};
...
use norte_tui::keymap::{
    Command, Count, Resolution, Resolver, chord_from_crossterm, count_ignored_message, presets,
    unavailable_message,
};
...
use norte_tui::overlays::{
    close_stale_overlays, help_owns_keys, modal_wins, settle_help_over_modal,
};
...
use norte_tui::viewer_open::{open_viewer, viewer_do, viewer_for};
...
/// entrada; el re-sort completo lo hace [`norte_tui::app::Pane::extend_listing`]). Un dir de
...
/// loop, que los aplica con [`norte_tui::app::Pane::extend_listing`]. Soltar el `rx` (un cd
