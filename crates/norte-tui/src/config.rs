...
pub use norte_config::{
    ...
    PersistSort, Watch, WatchMode, persist_columns, persist_hotlist_add, persist_hotlist_remove,
    persist_set, persist_ui_theme, persist_ui_theme_to, standard_layers, user_config_dir, watch,
    watch_polling,
};
