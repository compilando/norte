...
gui-task-kind-copy = copiar
gui-task-kind-move = mover
gui-task-kind-mkdir = crear carpeta
gui-task-kind-create = crear fichero
gui-task-kind-delete = borrar
gui-task-kind-undo = deshacer
gui-task-kind-search = buscar
gui-task-kind-index = indexar
gui-task-kind-embed = vectorizar
gui-task-kind-rename-batch = renombrar
...
setting-ui-lang-desc = Idioma de la interfaz. Déjalo sin fijar para negociarlo desde el entorno. Para una sola ejecución, `--lang` y NORTE_LANG mandan sobre él.
