...
setting-ui-alt-menu-desc = Si pulsar y soltar Alt solo abre la barra de menús en la TUI. Necesita un terminal con el protocolo de teclado de kitty (kitty, foot, WezTerm, Ghostty); tmux, xterm y GNOME Terminal no pueden avisar de un Alt suelto. Apagado por defecto: en ese modo una letra con tecla muerta (é) puede llegar sin su tilde. La GUI lo tiene siempre.
