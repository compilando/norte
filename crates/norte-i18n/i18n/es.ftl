...
cli-sync-failed = la planificación de sync falló
...
cli-sync-not-yet-applied = no se aplicó nada — la mitad de confirmar y aplicar de `sync` todavía no está conectada
